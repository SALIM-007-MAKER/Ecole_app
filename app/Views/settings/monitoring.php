...
<div class="flex items-center justify-between gap-4 mb-6">
    <div>
        ...
        <p class="text-sm text-slate-500">Supervision de votre établissement</p>
    </div>
    <form method="POST" action="<?= BASE_URL ?>/parametres/monitoring/vider-cache" onsubmit="return confirm('Vider le cache de votre établissement ?');">

...
<div class="p-6 space-y-6">
  ...
  <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    ...
    <div class="flex gap-2 flex-wrap">
      <a href="/v2/finance/comptabilite/journal" class="inline-flex items-center gap-2 bg-violet-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-violet-700">
        <i data-lucide="book-open" class="w-4 h-4"></i>Journal
      </a>
      <a href="/v2/finance/comptabilite/balance" class="inline-flex items-center gap-2 bg-slate-700 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-slate-800">
        <i data-lucide="scale" class="w-4 h-4"></i>Balance
      </a>
      <a href="/v2/finance/comptabilite/grand-livre" class="inline-flex items-center gap-2 bg-slate-100 text-slate-700 px-4 py-2 rounded-lg text-sm font-medium hover:bg-slate-200">
  ...
  <div class="bg-amber-50 border border-amber-200 rounded-xl p-6 text-center">
    ...
    <a href="/v2/finance/comptabilite/exercices/create" class="inline-flex items-center gap-2 bg-amber-600 text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-amber-700">
  ...
  <div class="bg-white rounded-xl border border-slate-200">
    <div class="p-5 border-b border-slate-100 flex items-center justify-between">
      ...
      <a href="/v2/finance/comptabilite/journal" class="text-sm text-violet-600 hover:text-violet-800">Voir tout →</a>
    </div>
  ...
  <div class="flex items-center justify-between text-sm text-slate-500">
    <a href="/v2/finance/comptabilite/exercices" class="hover:text-violet-600">

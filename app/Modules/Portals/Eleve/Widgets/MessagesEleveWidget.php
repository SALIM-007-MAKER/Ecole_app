...
class MessagesEleveWidget extends BaseWidget
{
    public function getId(): string    { return 'eleve_messages'; }
    public function getTitle(): string { return 'Mes messages'; }
    ...
    public function getTemplate(): string { return 'Portals::Shared/Widgets/eleve/messages'; }

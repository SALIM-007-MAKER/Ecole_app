...
<div class="max-w-xl mx-auto px-4 py-6">
    ...
    <form method="POST" action="<?= BASE_URL ?>/v2/inventaire/inventaires-physiques" class="bg-white rounded-xl shadow-sm p-6 space-y-5">
        ...
        <div class="flex justify-end gap-3 pt-2">
            <a href="<?= BASE_URL ?>/v2/inventaire/inventaires-physiques" class="px-4 py-2 text-sm text-slate-600 hover:text-slate-800">Annuler</a>

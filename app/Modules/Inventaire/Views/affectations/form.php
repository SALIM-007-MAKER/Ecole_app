...
<head>
    <meta charset="UTF-8">
    <title>Nouvelle affectation — Inventaire</title>
...
<div class="max-w-2xl mx-auto px-4 py-6">
    <div class="flex items-center gap-3 mb-6">
        <a href="/v2/inventaire/affectations" class="text-slate-500 hover:text-slate-700">
    ...
    <form method="POST" action="/v2/inventaire/affectations" class="bg-white rounded-xl shadow-sm p-6 space-y-5">
        ...
        <div class="flex justify-end gap-3 pt-2">
            <a href="/v2/inventaire/affectations" class="px-4 py-2 text-sm text-slate-600 hover:text-slate-800">Annuler</a>

...
<div class="max-w-4xl mx-auto px-4 py-6">
    ...
    <form method="POST" action="<?= BASE_URL ?>/v2/inventaire/commandes" class="space-y-6">
        ...
        <div class="flex justify-end gap-3">
            <a href="<?= BASE_URL ?>/v2/inventaire/commandes" class="px-4 py-2 text-sm text-slate-600 hover:text-slate-800">Annuler</a>

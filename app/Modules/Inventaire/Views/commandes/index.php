...
<head>
    <meta charset="UTF-8">
    <title>Commandes — Inventaire</title>
...
<div class="max-w-7xl mx-auto px-4 py-6">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="/v2/inventaire/commandes/creer"
    ...
    <div class="flex gap-2 mb-6 flex-wrap">
        ...
        <a href="/v2/inventaire/commandes<?= $s ? "?statut={$s}" : '' ?>"
            ...
            <?php foreach ($commandes as $c): ?>
                ...
                <tr class="hover:bg-slate-50">
                    ...
                    <td class="px-4 py-3 text-right space-x-2">
                        <a href="/v2/inventaire/commandes/<?=$c['id']?>" class="text-violet-600 hover:underline text-xs">Voir</a>
                        <?php if ($c['statut'] === 'brouillon'): ?>
                        <form method="POST" action="/v2/inventaire/commandes/<?=$c['id']?>/valider" class="inline">
                        ...
                        <a href="/v2/inventaire/commandes/<?=$c['id']?>/reception/creer" class="text-green-600 hover:underline text-xs">Réceptionner</a>
                        <?php endif; ?>
                    </td>
                </tr>
            <?php endforeach; ?>

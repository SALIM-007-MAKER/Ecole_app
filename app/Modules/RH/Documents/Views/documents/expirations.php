...
<div class="space-y-6">
  <div class="flex justify-between items-center">
    ...
    <a href="/v2/rh/documents" class="border border-slate-200 text-slate-600 px-4 py-2 rounded-lg text-sm hover:bg-slate-50 transition">
  ...
  <div class="flex gap-2">
    ...
    <a href="/v2/rh/documents/expirations?jours=<?= $j ?>"
  ...
  <div class="bg-red-50 border border-red-200 rounded-xl p-4">
    ...
    <div class="space-y-2">
      ...
      <div class="bg-white rounded-lg p-3 flex items-center justify-between">
        ...
        <a href="/v2/rh/documents/<?= (int)$d['id'] ?>" class="text-violet-600 hover:text-violet-800 text-sm font-medium">Traiter</a>
      </div>
      <?php endforeach; ?>
    </div>
  </div>

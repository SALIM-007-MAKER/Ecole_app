  ...
  <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-5">
    <div class="flex items-start justify-between gap-4">
      <div class="flex-1">
        <div class="flex items-center gap-2 mb-2 flex-wrap">
          <a href="/v2/rh/documents" class="text-slate-400 hover:text-slate-600 text-xs">Documents RH</a>
      ...
      <div class="flex gap-2 flex-shrink-0">
        ...
        <a href="/v2/rh/documents/<?= (int)$doc['id'] ?>/edit"
        ...
        <?php if ($policy->canArchive($user)): ?>
          ...
          <?php else: ?>
          <form method="POST" action="/v2/rh/documents/<?= (int)$doc['id'] ?>/restaurer">
            <?= \Core\Csrf::field() ?>
    ...
    <div class="mt-3 pt-3 border-t border-slate-100">
      ...
      <div class="flex gap-2 flex-wrap">
        ...
        <a href="/v2/rh/contrats/<?= (int)$doc['contrat_id'] ?>"
        ...
        <a href="/v2/rh/formations/sessions/<?= (int)$doc['formation_session_id'] ?>"
        ...
        <a href="/v2/rh/evaluations/<?= (int)$doc['evaluation_id'] ?>"
...
<div id="modal-archiver" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
  <div class="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
    ...
    <form method="POST" action="/v2/rh/documents/<?= (int)$doc['id'] ?>/archiver">
      <?= \Core\Csrf::field() ?>
      <div class="mb-4">

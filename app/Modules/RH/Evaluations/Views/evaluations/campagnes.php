...
<title>Campagnes d'évaluation — EduNova</title>
...
<main class="ml-64 p-8">
  ...
  <div class="flex items-center justify-between mb-8">
    ...
    <div class="flex gap-3">
      <a href="/v2/rh/evaluations" class="px-4 py-2 bg-white border border-slate-200 text-slate-600 rounded-lg text-sm hover:bg-slate-50">
        Évaluations
      </a>
      <?php if ($policy->canCreate($user)): ?>
      <a href="/v2/rh/evaluations/campagnes/create"
    ...
    <div class="bg-white border border-slate-100 rounded-xl p-5 shadow-sm">
      <div class="flex items-start justify-between gap-4">
        ...
        <div class="flex flex-col gap-2 flex-shrink-0">
          ...
          <form method="POST" action="/v2/rh/evaluations/campagnes/<?= (int)$c['id'] ?>/activer"
          ...
          <form method="POST" action="/v2/rh/evaluations/campagnes/<?= (int)$c['id'] ?>/cloturer"
          ...
          <?php endif; ?>
          <a href="/v2/rh/evaluations?campagne_id=<?= (int)$c['id'] ?>"

...
<div class="flex items-start gap-4 mb-6">
    ...
    <div>
        <h2 class="text-xl font-bold text-slate-900">Nouveau profil enseignant</h2>
...
<form method="POST" action="<?= BASE_URL ?>/v2/rh/enseignants" class="space-y-6">
    ...
    <div class="bg-white border border-slate-200 rounded-xl shadow-sm">
        <div class="px-5 py-4 border-b border-slate-100 flex items-center gap-2">
            ...
            <h3 class="font-semibold text-slate-900 text-sm">Employé associé <span class="form-required">*</span></h3>
        </div>
        <div class="p-5">
            ...
            <select name="employe_id" required
                    class="form-select <?= $hasE('employe_id') ? 'is-invalid' : '' ?>">

...
<div class="flex flex-wrap items-center justify-between gap-4 mb-6">
    <div>
        ...
        <p class="text-sm text-slate-500 mt-0.5">Profils pédagogiques — Module RH V2</p>
    </div>
...
<div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
    <div class="bg-white border border-slate-200 rounded-xl p-4">
        ...
        <div class="text-xs text-slate-500 mt-0.5">Titulaires</div>
    </div>
    <div class="bg-white border border-slate-200 rounded-xl p-4">
        <div class="text-2xl font-bold text-blue-600"><?= (int)($stats['par_statut']['vacataire'] ?? 0) ?></div>
        <div class="text-xs text-slate-500 mt-0.5">Vacataires</div>
    </div>
    <div class="bg-white border border-slate-200 rounded-xl p-4">
        <div class="text-2xl font-bold text-slate-700"><?= array_sum($stats['par_statut'] ?? []) ?></div>
        <div class="text-xs text-slate-500 mt-0.5">Total profils</div>
    </div>
    <div class="bg-white border border-slate-200 rounded-xl p-4">
...
<div class="bg-white border border-slate-200 rounded-xl shadow-sm p-4 mb-6">
    <form method="GET" class="flex flex-wrap gap-3 items-end">
        ...
        <div>
            ...
            <select name="matiere_id" class="rounded-lg border border-slate-200 text-sm px-3 py-1.5 bg-white focus:ring-2 focus:ring-violet-300 focus:outline-none">

...
?>
  ...
  <div class="flex items-start gap-4 mb-8">
    ...
    <h1 class="text-2xl font-bold text-slate-900 pt-2">Nouveau département</h1>
  </div>
  ...
  <form method="POST" action="<?= BASE_URL ?>/v2/rh/organisation/departements" class="bg-white rounded-xl border border-slate-200 p-6 space-y-5">
    <?php \Core\Csrf::field(); ?>
    ...
    <div class="flex justify-end gap-3 pt-2">
      <a href="<?= BASE_URL ?>/v2/rh/organisation/departements"

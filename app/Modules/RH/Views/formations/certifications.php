...
<div id="modal-cert" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
  <div class="bg-white rounded-xl shadow-xl w-full max-w-lg p-6">
    ...
    <form method="POST" action="<?= BASE_URL ?>/v2/rh/formations/certifications">
      <?= \Core\Csrf::field() ?>
      <div class="space-y-4">
        <div>
        ...
        <div>
          ...
          <select name="certification_id" required class="form-select">
            <option value="">Sélectionner…</option>
        ...
        <div class="grid grid-cols-2 gap-3">
          ...
          <div>
            <label class="form-label">Réf. certificat</label>

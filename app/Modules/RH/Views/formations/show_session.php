...
$inscColors = $model::INSCRIPTION_COLORS ?? [];
    ...
    <div class="flex items-start justify-between gap-4">
      <div>
        <div class="flex items-center gap-2 mb-1">
          <a href="<?= BASE_URL ?>/v2/rh/formations" class="text-slate-400 hover:text-slate-600 text-xs">Sessions</a>
            ...
            <tr class="hover:bg-slate-50">
              ...
              <td class="px-4 py-3 text-right">
                <div class="flex gap-1 justify-end">
                  ...
                  <form method="POST" action="<?= BASE_URL ?>/v2/rh/formations/inscriptions/<?= (int)$insc['id'] ?>/presence">
                    <?= \Core\Csrf::field() ?>
                  ...
                  <form method="POST" action="<?= BASE_URL ?>/v2/rh/formations/inscriptions/<?= (int)$insc['id'] ?>/annuler"
...
<div id="modal-inscrire" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
  <div class="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
    ...
    <form method="POST" action="<?= BASE_URL ?>/v2/rh/formations/sessions/<?= (int)$session['id'] ?>/inscrire">
      <?= \Core\Csrf::field() ?>
      <div class="mb-4">
...
<div id="modal-valider" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
  <div class="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
    ...
    <form id="form-valider" method="POST">
      ...
      <input type="hidden" name="session_id" value="<?= (int)$session['id'] ?>">
      <div class="mb-3">
        <label class="form-label">Note /20 (optionnel)</label>

...
<div class="space-y-6">
  ...
  <div class="flex items-start gap-2 text-sm text-slate-500">
    ...
    <span class="text-slate-700">Formations</span>
  </div>
  ...
  <div class="flex items-start gap-4">
    ...
    <div>
      <h1 class="text-2xl font-bold text-slate-900">Formations du personnel</h1>
      <p class="text-sm text-slate-500 mt-0.5">Sessions, inscriptions et attestations</p>
    </div>
  </div>
  ...
  <div class="flex justify-between items-center">
    ...
    <div class="flex gap-2">
      ...
      <a href="<?= BASE_URL ?>/v2/rh/formations/export?<?= http_build_query($_GET) ?>" class="border border-slate-200 text-slate-600 px-4 py-2 rounded-lg text-sm hover:bg-slate-50 transition flex items-center gap-1">
      ...
      <tbody class="divide-y divide-slate-100">
        ...
        <tr>
          <td colspan="7" class="py-14">
            <div class="flex flex-col items-center gap-2 text-slate-400">
              ...
              <p class="text-sm">Aucune session trouvée</p>
            </div>
          </td>
        </tr>
        <?php endif; ?>
        ...
        <tr class="hover:bg-slate-50 transition">
          ...
          <td class="px-4 py-3 text-right">
            <a href="<?= BASE_URL ?>/v2/rh/formations/sessions/<?= (int)$s['id'] ?>"

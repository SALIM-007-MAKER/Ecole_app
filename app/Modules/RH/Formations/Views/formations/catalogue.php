...
$typeColors = $model::FORMATION_COLORS ?? [];
?>
<div class="space-y-6">
  <div class="flex justify-between items-center">
    ...
    <div class="flex gap-2">
      ...
      <a href="/v2/rh/formations/catalogue/create" class="bg-violet-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-violet-700 transition">
  ...
  <div class="flex gap-2 flex-wrap">
    <a href="/v2/rh/formations/catalogue"
    ...
    <a href="/v2/rh/formations/catalogue?type=<?= urlencode($t) ?>"
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-5 flex flex-col gap-3 hover:shadow-md transition">
      ...
      <a href="/v2/rh/formations/sessions/create?formation_id=<?= (int)$f['id'] ?>"

...
<div class="max-w-2xl mx-auto px-4 py-8">
    <div class="flex items-center gap-3 mb-6">
        <a href="/v2/rapports/exports" class="text-slate-400 hover:text-violet-600">
    ...
    <div class="bg-white rounded-xl border border-slate-100 p-6">
        <form method="get" action="/v2/rapports/exports/apercu" class="space-y-5">
            ...
            <div class="flex gap-3 pt-2">
                ...
                <button type="submit" formaction="/v2/rapports/exports/csv"
                ...
                <button type="submit" formaction="/v2/rapports/exports/excel"
                        class="px-4 py-2 border border-slate-200 text-slate-700 rounded-lg text-sm hover:bg-slate-50">

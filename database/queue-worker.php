...
// Charger .env s'il existe ; sinon on suppose que les variables sont déjà
// fournies par l'environnement réel (conteneur, plateforme PaaS) — voir
// database/migrate.php pour le contexte (portabilité conteneur).
